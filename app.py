...
def markdown_to_json(state: State):
    ...
    #print("Generated JSON:", str_response.content)
...
def create_podcast_workflow():
    ...
    # Copy the workflow nodes and edges from the original script
    # (Include the entire workflow implementation here)
    # This would include nodes like generate_steps, markdown_to_json, parse_json, etc.
    # For brevity, I'm omitting the full implementation, but you'd paste the entire workflow here
